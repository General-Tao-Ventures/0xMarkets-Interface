      ...
      <ul className={UL_CLASS_NAME}>
        ...
        {isTradeBox ? (
          <li className={LI_CLASS_NAME}>
            ...
            <ExternalLink href="https://docs.0xmarkets.io/trading/order-types#limit-orders">
        ...
        <li className={LI_CLASS_NAME}>
          ...
          <ExternalLink href="https://docs.0xmarkets.io/trading/order-types#take-profit-and-stop-loss-orders">
            <Trans>Read more</Trans>
          </ExternalLink>
          .
        </li>
        {isTradeBox ? (
          <li className={LI_CLASS_NAME}>
            <Trans>
              ...
              the price is above the trigger price.
            </Trans>{" "}
            <ExternalLink href="https://docs.0xmarkets.io/trading/order-types#stop-market-orders">
              <Trans>Read more</Trans>
            </ExternalLink>
            .
          </li>
        ...
        <li className={LI_CLASS_NAME}>
          ...
          <ExternalLink href="https://docs.0xmarkets.io/trading/order-types#twap-orders">
            <Trans>Read more</Trans>
          </ExternalLink>
          .
        </li>
