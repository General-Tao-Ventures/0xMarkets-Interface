...
- [ ] **FIX-02**: All 6 markets pass liquidity checks (complete on-chain reserve factors and OI limits)
...
- [ ] **POS-01**: User can open long and short positions via market order on any of the 6 markets
...
- [ ] **LIQ-01**: User can withdraw liquidity from pools (Sell GM) and receive underlying tokens
