...
export const gmxPages: EcosystemGmxPage[] = [
  {
    title: msg`0xMarkets Governance`,
    link: "https://gov.gmx.io/",
    linkLabel: "gov.gmx.io",
    about: msg`0xMarkets Governance Page`,
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Proposals`,
    link: "https://snapshot.org/#/gmx.eth",
    linkLabel: "snapshot.org",
    about: msg`0xMarkets Proposals Voting page`,
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Announcements`,
    link: "https://t.me/GMX_Announcements",
    linkLabel: "t.me",
    about: msg`0xMarkets Announcements and Updates`,
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`Dune Analytics for 0xMarkets`,
  ...
  {
    title: msg`0xMarkets Technical Announcements`,
    link: "https://t.me/GMX_Technical_Announcements",
    linkLabel: "t.me",
    about: msg`0xMarkets Technical Announcements`,
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Substack`,
    link: "https://gmxio.substack.com/",
    linkLabel: "substack.com",
    about: msg`0xMarkets Substack`,
    chainIds: [ARBITRUM, AVALANCHE],
  },
];
...
export const communityProjects: EcosystemCommunityProject[] = [
  {
    title: msg`0xMarkets Blueberry Club`,
    link: "https://hub.findgbc.io/",
    linkLabel: "findgbc.io",
    about: msg`0xMarkets Community with NFTs, Trading and Education initiatives`,
    creatorLabel: "@xm_gbc",
    creatorLink: "https://t.me/xm_gbc",
    chainIds: [ARBITRUM],
  },
  {
    title: msg`0xMarkets Positions Bot`,
    link: "https://t.me/GMXv2Positions",
    linkLabel: "t.me",
    about: msg`Telegram bot for 0xMarkets position updates`,
  ...
  },
  {
    ...
    linkLabel: "substack.com",
    about: msg`0xMarkets Weekly Updates`,
    creatorLabel: "@1tbk1",
    creatorLink: "https://x.com/1tbk1",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Trading Stats`,
    link: "https://t.me/GMXTradingStats",
    linkLabel: "t.me",
    about: msg`Telegram bot for Open Interest on 0xMarkets`,
    creatorLabel: "@SniperMonke01",
    creatorLink: "https://x.com/SniperMonke01",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Swaps`,
    link: "https://t.me/GMXSwaps",
    linkLabel: "t.me",
    about: msg`Telegram bot for 0xMarkets Swaps monitoring`,
    creatorLabel: "@snipermonke01",
    creatorLink: "https://x.com/snipermonke01",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`SNTL es0xM Market`,
    link: "https://sntl.market/",
    linkLabel: "sntl.market",
    about: msg`es0xM OTC Market`,
    creatorLabel: "@sntlai",
  ...
  {
    title: msg`0xMarkets Telegram & Discord Analytics`,
    link: "https://t.me/gmx_v2_bot",
    linkLabel: "t.me",
    about: msg`0xMarkets Data Analytics within Telegram`,
  ...
  {
    title: msg`Generative Market eXplore - AI0xM Agent`,
    link: "https://x.com/aigmx_agent",
    linkLabel: "x.com",
    about: msg`Real-time rants about 0xMarkets Trades`,
...
export const dashboardProjects: EcosystemDashboardProject[] = [
  {
    title: msg`0xMarkets Referrals Dashboard`,
    link: "https://www.gmxreferrals.com/",
    linkLabel: "gmxreferrals.com",
    about: msg`Dashboard for 0xMarkets referral stats`,
  ...
  },
  {
    ...
    about: msg`0xMarkets fundamentals`,
    creatorLabel: "@tokenterminal",
    creatorLink: "https://x.com/tokenterminal",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`0xMarkets Risk Monitoring`,
  ...
  {
    title: msg`Saulius 0xMarkets Analytics`,
  ...
  },
  {
    ...
    about: msg`Trading Simulations on 0xMarkets using DOJO`,
  ...
  },
  {
    ...
    linkLabel: "compasslabs.ai",
    about: msg`0xMarkets Market Token Price Chart`,
    creatorLabel: "@labs_compass",
    creatorLink: "https://x.com/labs_compass",
    chainIds: [ARBITRUM, AVALANCHE],
  },
...
export const integrations: EcosystemGmxPage[] = [
  ...
  },
  {
    ...
    linkLabel: "beefy.com",
    about: msg`GLP and 0xMarkets autocompounding vaults`,
