  ...
  return (
    <div className="flex w-full flex-col gap-8">
      ...
      <BuyCard
        ...
        description={
          <Trans>
            GLV vaults automatically balance liquidity across multiple 0xMarkets pools and accrue fees generated by
            them.
          </Trans>
        }
        alt="GLV icon"
      ...
      <BuyCard
        ...
        description={
          <Trans>
            Provide liquidity to 0xMarkets markets and earn 63% of the fees generated by traders.
          </Trans>
        }
        alt="Pools icon"
        type="buy"
