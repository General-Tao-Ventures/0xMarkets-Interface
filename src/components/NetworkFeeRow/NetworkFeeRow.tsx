    ...
    () =>
      isAdditionOrdersMsg && (
        <Trans>
          ...
          <ExternalLink href="https://docs.0xmarkets.io/trading/fees#execution-fee">Read more</ExternalLink>.
        </Trans>
      ),
    [isAdditionOrdersMsg]
  );
        ...
        content={
          <>
            ...
            <p>
              ...
              <ExternalLink className="inline" href="https://docs.0xmarkets.io/trading/fees#execution-fee">
