...
export default function PartnershipsJoin() {
  ...
  return (
    <AppPageLayout>
      {/* AppPageLayout's own max-w-full beats a contentClassName width, so the measure is set
          here instead — long marketing prose is unreadable at full desktop width. */}
      <div className="mx-auto flex w-full max-w-[1100px] flex-col gap-32 pb-32">
        {/* ---------------- hero ---------------- */}
        ...
        <section>
          ...
          <div className="mt-16 flex flex-col gap-8">
            ...
            <Faq q={t`Do my traders pay more because they used my link?`}>
              <Trans>
                No. They pay the same fee as everyone else — your commission comes out of the venue's share.
              </Trans>
            </Faq>
        ...
        <section className="rounded-4 bg-slate-800 p-32 text-center">
          ...
          <p className="leading-relaxed mx-auto mt-24 max-w-[80ch] text-left text-11 text-slate-100">
            <Trans>
              <b>Illustrative figures.</b> All commission examples on this page assume a blended trading fee of 0.025%
              and are estimates, not a projection of earnings. Actual commission depends on the markets your traders
              use, the balance of their flow and the volume they trade. Tier rates and requirements are set by
              governance and can change.
            </Trans>
            <br />
            <br />
            <Trans>
              <b>Eligibility.</b> Trading leveraged derivatives carries significant risk. This programme is not
              available to, and must not be promoted to, residents of restricted jurisdictions. Partners are a regulated
              category in many territories and you are responsible for your own licensing, disclosures and marketing
              conduct. Nothing here is an offer, an inducement or investment advice.
            </Trans>
          </p>
        </section>
      </div>
