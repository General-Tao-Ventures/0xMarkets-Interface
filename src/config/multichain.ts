...
export const DEFAULT_SETTLEMENT_CHAIN_ID_MAP: Record<AnyChainId, SettlementChainId> = {
  [SOURCE_BASE_MAINNET]: SOURCE_BASE_MAINNET,
  [BASE_SEPOLIA]: BASE_SEPOLIA,
  [LOCALHOST]: SOURCE_BASE_MAINNET,
};
...
export const MULTICALLS_MAP: Record<SourceChainId, string> = {
  ...
  [BASE_SEPOLIA]: "0xca11bde05977b3631167028862be2a173976ca11",
};
...
export const CHAIN_ID_PREFERRED_DEPOSIT_TOKEN: Record<SettlementChainId, string> = {
  [SOURCE_BASE_MAINNET]: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", // USDC on Base
  [BASE_SEPOLIA]: "0xFDDFE40Ade3eE9aDE4A2e185C750cf28025BFd6b", // mUSDC on Base Sepolia
};
...
export const CHAIN_ID_TO_ENDPOINT_ID: Record<SettlementChainId | SourceChainId, LayerZeroEndpointId> = {
  ...
  [BASE_SEPOLIA]: 40245, // Base Sepolia LayerZero endpoint ID
};
