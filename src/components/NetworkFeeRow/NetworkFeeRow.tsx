    ...
    () =>
      isAdditionOrdersMsg && (
        <Trans>
          ...
          <ExternalLink href="https://docs.0xmarkets.io/docs/trading/v2#execution-fee">Read more</ExternalLink>.
        </Trans>
      ),
    [isAdditionOrdersMsg]
  );
        ...
        content={
          <>
            ...
            <p>
              ...
              <ExternalLink className="inline" href="https://docs.0xmarkets.io/docs/trading/v2#execution-fee">
      ...
      <ExchangeInfoRow
        label={
          <TooltipWithPortal
            ...
            content={
              <Trans>
                The maximum network fee paid to the network. This fee is a blockchain cost not specific to 0xMarkets, and
