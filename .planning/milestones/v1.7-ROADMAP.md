...
- ✅ **v1.7 Liquidation Readiness** — Phases 24-27 (shipped 2026-02-28)
...
- [x] **Phase 27: Liquidation Pipeline End-to-End Execution** - Scanner refactored to view-call pricing, pipeline verified through gas-estimation, pool reserve exhaustion prevented final on-chain TX (completed 2026-02-28)
...
**Plans**: 1 plan
Plans:
- [x] 27-01-PLAN.md -- Seed pool, create positions, refactor scanner to view-call pricing, verify pipeline through gas-estimation
